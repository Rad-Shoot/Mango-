...
const textDisplay = document.querySelector('.carousel-text');
const phrases = ['We Build Phones that Last Lifetimes', 'We Accomplish the Impossible', 'Innovate, Invent, Inspire'];
let i = 0;
let j = 0;
let currentPhrase = [];
